...
const handleLike = async (postId) => {
  try {
    ...
    if (!response.ok) {
      throw new Error("いいね！の追加に失敗しました。");
    }
...
<PostDetail post={selectedPost} onLike={handleLike} />
  ...
  // handleMapClick関数を削除またはコメントアウト
  // このロジックはJapanMapコンポーネント内で直接処理されるため不要
    ...
    <div className="App">
      ...
      <main className="App-main">
        <div className="map-container">
          {/* JapanMapにpostsとonPinClickを渡すように修正 */}
